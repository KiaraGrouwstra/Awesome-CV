...
```bash
# merge cv + cover letter into single pdf:
/media/tycho/Drogon/Coding/latex/Awesome-CV/examples/build/90$ gs -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -sOutputFile=cv-coverletter.pdf coverletter-tycho.pdf "/media/tycho/Drogon/Coding/latex/Fancy CV/build/ml/cv-tycho-en.pdf"
```
