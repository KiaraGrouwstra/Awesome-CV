% lang=en; xelatex -jobname="grouwstra tycho motivation letter" -output-directory="build/tut" "\newif\ifen\newif\ifnl\\${lang}true \input{coverletter-tut}"
\documentclass[11pt, a4paper]{awesome-cv}
    ...
    \recipient
      ...
      {}
    \letterdate{\today}
    \lettertitle{\langen{Cover Letter Application for}\langnl{Motivatie aanmelding voor} TUT Master 
    Robotics and Artificial Intelligence
    % Data Engineering and Machine Learning
    }
    \letteropening{\newline\langen{Dear}\langnl{Beste} TUT admissions office,\newline}
    \letterclosing{%
      \langen{Sincerely}%
