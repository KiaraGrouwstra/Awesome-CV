% mkdir build/cuni; lang=en; xelatex -jobname="cuni" -output-directory="build/cuni" "\newif\ifen\newif\ifnl\\${lang}true \input{coverletter-cuni}"
\documentclass[11pt, a4paper]{awesome-cv}
    ...
    \letteropening{\newline\langen{Dear}\langnl{Beste} Charles University admissions office,\newline}
    \letterclosing{%
      \langen{Sincerely}%
