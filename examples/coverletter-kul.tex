% mkdir build/kul; lang=en; xelatex -jobname="kul" -output-directory="build/kul" "\newif\ifen\newif\ifnl\\${lang}true \input{coverletter-kul}"
\documentclass[11pt, a4paper]{awesome-cv}
    ...
    \recipient
      ...
      {}
    \letterdate{\today}
    \lettertitle{\langen{Cover Letter Application for}\langnl{Motivatie aanmelding voor} KU Leuven Master 
    Artificial Intelligence
    % Data Engineering and Machine Learning
    }
    \letteropening{\newline\langen{Dear}\langnl{Beste} KUL admissions office,\newline}
    \letterclosing{%
      \langen{Sincerely}%
